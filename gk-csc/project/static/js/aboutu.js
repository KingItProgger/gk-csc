...
const a2=`<button onclick="backward(2)"></button><div class="about">
    <p>
...
</div><button onclick="forward(2)" ></button>`
const a3=`<button onclick="backward(3)"></button><div class="about">
    <p>
...
</div><button onclick="forward(3)" ></button>`
const a4=`<button onclick="backward(4)"></button><div class="about">
    <p>
...
</div><button onclick="forward(4)" ></button>`
const a5=`<button onclick="backward(5)"></button><div class="about">
    <p>
...
</div><button onclick="forward(5)" ></button>`
